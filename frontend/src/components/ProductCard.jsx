...
const ProductCard = ({ product }) => {
    ...
    return (
        <Link to={`/products/${product._id}`} className="block h-full">
            <div className="card group h-full flex flex-col hover:shadow-2xl transition-shadow duration-300">
                {/* Image Container */}
                <div className="relative overflow-hidden bg-gray-100 h-48">
                    ...
                    {user && !user.isAdmin && (
                        <button
                            ...
                            className="absolute top-2 left-2 bg-white bg-opacity-90 hover:bg-opacity-100 p-2 rounded-full transition-all shadow-lg disabled:opacity-50 z-10"
                        >
                            <svg
